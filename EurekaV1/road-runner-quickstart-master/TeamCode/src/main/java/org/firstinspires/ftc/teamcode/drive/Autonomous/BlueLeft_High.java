...
@Disabled
@Autonomous
public class BlueLeft_High extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d PARKING2 = new Pose2d(36, 32, Math.toRadians(90));
        ...
        Pose2d startPose = new Pose2d(38, 63, Math.toRadians(180));     //63 y value for tis
        drive.setPoseEstimate(startPose);

        TrajectorySequence traj1 =drive.trajectorySequenceBuilder(startPose)
                .lineToConstantHeading(new Vector2d(35, 63))     //63 y value for tis
                .waitSeconds(0.001)
                .lineToLinearHeading(new Pose2d(35.7, 3.2, Math.toRadians(196)))
                .build();

        TrajectorySequence lock1 =drive.trajectorySequenceBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(35.71, 3.21, Math.toRadians(196)))
                .build();
