...
@Autonomous
public class LSH extends LinearOpMode
{
...
//                .lineToLinearHeading(new Pose2d(12,-20, Math.toRadians(196)))  // dropping position
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.85,()->{Servos.Gripper.Lock();Servos.Arm.goInit();Servos.Rotate.rotatePick();Servos.Arm.goActiveStable();})
                .lineToLinearHeading(new Pose2d(-12,-20, Math.toRadians(-16)))
