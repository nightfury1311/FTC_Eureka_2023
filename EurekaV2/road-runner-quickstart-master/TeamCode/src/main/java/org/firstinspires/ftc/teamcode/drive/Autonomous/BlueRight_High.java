...
@Disabled
@Autonomous
public class BlueRight_High extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d startPose = new Pose2d(-38, 63, Math.toRadians(0));    //63 y value for tis
        drive.setPoseEstimate(startPose);

        TrajectorySequence traj1 =drive.trajectorySequenceBuilder(startPose)
                .lineToConstantHeading(new Vector2d(-35, 63))        //63 y value for tis //61 for blue dais //62 for red dais
                .waitSeconds(0.001)
                .lineToLinearHeading(new Pose2d(-35.3, 3, Math.toRadians(344)))
                .build();

        TrajectorySequence lock1 =drive.trajectorySequenceBuilder(traj1.end())
                .lineToLinearHeading(new Pose2d(-35.31, 3.01, Math.toRadians(344)))
                .build();
