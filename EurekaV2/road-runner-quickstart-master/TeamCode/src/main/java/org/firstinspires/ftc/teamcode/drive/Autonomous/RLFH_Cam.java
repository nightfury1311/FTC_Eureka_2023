...
@Disabled
@Autonomous
public class RLFH_Cam extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        TrajectorySequence pre =drive.trajectorySequenceBuilder(startPose)
                ...
                .lineToLinearHeading(new Pose2d(-35, -3,Math.toRadians(15)))
                .build();
        TrajectorySequence lock1 =drive.trajectorySequenceBuilder(pre.end())
                .lineToLinearHeading(new Pose2d(-35.00001, -3.0001, Math.toRadians(15)))
                .build();
        TrajectorySequence lock2 =drive.trajectorySequenceBuilder(lock1.end())
                .lineToLinearHeading(new Pose2d(-35.001, -3, Math.toRadians(15)))
                .build();
