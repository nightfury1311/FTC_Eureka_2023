...
//
//@Config
//@TeleOp(name = "APOCcopy")
//public class APOCCOPY extends LinearOpMode {
//
//    Servos servos = null;
//    ElapsedTime timerr=null;
//    ElevatorEx elevatorEx;
//
//    public static double max=680;
...
//        elevatorEx=new ElevatorEx(hardwareMap,telemetry);
//
//        timerr=new ElapsedTime();
//
//        Robot drive = new Robot(hardwareMap, telemetry,elevatorEx);
...
//
//            if(gamepad1.a){
//                elevatorEx.goToElevator(max,10000,6500);
//            } else if (gamepad1.b) {
//                elevatorEx.goToElevator(min,10000,6500);
//
//            }
//
////            if(gamepad1.x){
