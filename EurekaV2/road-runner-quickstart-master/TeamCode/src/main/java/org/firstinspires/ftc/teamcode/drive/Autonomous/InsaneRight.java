...
@Autonomous
public class InsaneRight extends LinearOpMode
{
    ...
    public void runOpMode() throws InterruptedException
    {
        ...
        Pose2d startPose = new Pose2d(30, -62, Math.toRadians(90));    //63 y value for tis
        ...
        TrajectorySequence pre =drive.trajectorySequenceBuilder(startPose)
                ...
                .addTemporalMarker(()->elevator.extendTo(elevator.POSITIONS[elevator.LOW_POLE]))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);})
                .splineToLinearHeading(new Pose2d(27, -12, Math.toRadians(115)), Math.toRadians(122.01))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);Servos.Arm.goPickCone1();Servos.Gripper.openGripper();})
                .UNSTABLE_addTemporalMarkerOffset(-0.2,()->elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]))
                .waitSeconds(0.5)
                ...
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);Servos.Arm.goActivePick1();Servos.Gripper.openGripper();})
                .waitSeconds(0.1)
                .addTemporalMarker(()->{Servos.Gripper.closeGripper();})
                .waitSeconds(0.2)
                .addTemporalMarker(()->Servos.Arm.goInit())
                .waitSeconds(0.1)
                .addTemporalMarker(()->{Servos.Rotate.rotateDrop();Servos.Arm.goActiveDrop();})
                .UNSTABLE_addTemporalMarkerOffset(0.6,()->Servos.Arm.goDrop())
                .UNSTABLE_addTemporalMarkerOffset(0.8,()->Servos.Gripper.openGripper())
                .UNSTABLE_addTemporalMarkerOffset(0.95,()->{elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]);Servos.Arm.goInit();})
                .UNSTABLE_addTemporalMarkerOffset(1,()->{Servos.Gripper.Lock();Servos.Rotate.rotatePick();})


                // SCORING CONE 1
                .lineToLinearHeading(new Pose2d(25, -12, Math.toRadians(115)))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);Servos.Arm.goPickCone2();Servos.Gripper.closeGripper();})
//                .waitSeconds(0.2)
//                .addTemporalMarker(()->elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]))
                .waitSeconds(0.6)
                .addTemporalMarker(()->{elevator.extendTo(elevator.POSITIONS[elevator.HOME]);Servos.Gripper.closeGripper();})
                .waitSeconds(0.05)
                .addTemporalMarker(()->{Servos.Gripper.Unlock();})

                // CONE 2 PICKUP
                .lineToLinearHeading(new Pose2d(50, -12, Math.toRadians(180)))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);Servos.Arm.goActivePick2();Servos.Gripper.openGripper();})
                .waitSeconds(0.1)
                .addTemporalMarker(()->{Servos.Gripper.closeGripper();})
                .waitSeconds(0.2)
                .addTemporalMarker(()->Servos.Arm.goInit())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.6,()->Servos.Arm.goDrop())
                .UNSTABLE_addTemporalMarkerOffset(0.8,()->Servos.Gripper.openGripper())
                .UNSTABLE_addTemporalMarkerOffset(0.95,()->{elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]);Servos.Arm.goPickCone3();})
                .UNSTABLE_addTemporalMarkerOffset(1,()->{Servos.Gripper.Lock();Servos.Rotate.rotatePick();})
                // SCORING CONE 2
                .lineToLinearHeading(new Pose2d(25, -12, Math.toRadians(115)))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);})
...
//                .addTemporalMarker(()->elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]))
                ...
                // CONE 3 PICKUP
                .lineToLinearHeading(new Pose2d(50, -12, Math.toRadians(180)))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);Servos.Arm.goActivePick3();Servos.Gripper.openGripper();})
                .waitSeconds(0.1)
                .addTemporalMarker(()->{Servos.Gripper.closeGripper();})
                .waitSeconds(0.2)
                .addTemporalMarker(()->Servos.Arm.goInit())
                ...
                .UNSTABLE_addTemporalMarkerOffset(0.6,()->Servos.Arm.goDrop())
                .UNSTABLE_addTemporalMarkerOffset(0.8,()->Servos.Gripper.openGripper())
                .UNSTABLE_addTemporalMarkerOffset(0.95,()->{elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]);Servos.Arm.goPickCone4();})
                .UNSTABLE_addTemporalMarkerOffset(1,()->{Servos.Gripper.Lock();Servos.Rotate.rotatePick();})
                // SCORING CONE 3
                .lineToLinearHeading(new Pose2d(25, -12, Math.toRadians(115)))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);})
...
//
                // CONE 4 PICKUP
                .lineToLinearHeading(new Pose2d(49, -13.5, Math.toRadians(180)))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);Servos.Arm.goActivePick4();Servos.Gripper.openGripper();})
                .waitSeconds(0.1)
                .addTemporalMarker(()->{Servos.Gripper.closeGripper();})
                .waitSeconds(0.2)
                .addTemporalMarker(()->Servos.Arm.goInit())
...
//                .addTemporalMarker(()->elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]))
                ...
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);Servos.Arm.goPick();Servos.Arm.goActivePick();Servos.Gripper.openGripper();})
                .waitSeconds(0.1)
                .addTemporalMarker(()->{Servos.Gripper.closeGripper();})
                .waitSeconds(0.2)
                .addTemporalMarker(()->Servos.Arm.goInit())
                ...
                .UNSTABLE_addTemporalMarkerOffset(1,()->{Servos.Gripper.Lock();Servos.Rotate.rotatePick();})
                //SCORING CONE 5
                .lineToLinearHeading(new Pose2d(25, -15, Math.toRadians(115)))
                .addTemporalMarker(()->{slide.extendTo(slide.POSITIONS[slide.HOME]);})
//                .waitSeconds(0.2)
//                .addTemporalMarker(()->elevator.extendTo(elevator.POSITIONS[elevator.HIGH_POLE]))
                .waitSeconds(0.6)
