...
//        }
//
//        withinTolerance = Math.abs(getPos() - getTargetPos()) < 20;
//
//        power = Range.clip(((-controller.calculate(liftPosition, targetPosition) + (F * Math.signum(targetPosition - liftPosition))) / elevator_sub.getVoltage() * 14), -1, 1);
//    }
//
//    public void write() {
//        try {
