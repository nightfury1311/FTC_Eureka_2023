...
@Disabled
@Config
@TeleOp(name = "sensor3d")
public class sensor3d extends LinearOpMode {
    Servo servoGripper;
    Servo servoLeft;
    Servo servoRight;
    Servo servoRotation;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        DropMagNew = hardwareMap.get(TouchSensor.class, "DropMagNew");
...
//                SliderHome();
    ...
    public void SliderDrop(){
        while(((!DropMag.isPressed() && !DropMagNew.isPressed()) || (!DropMagNew.isPressed()) || (!DropMag.isPressed())) && opModeIsActive()){
            servoLeft.setPosition(HOME_ARM);
            servoRight.setPosition(HOME_ARM);
            SlideRight.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
            SlideLeft.setMode(DcMotor.RunMode.RUN_WITHOUT_ENCODER);
